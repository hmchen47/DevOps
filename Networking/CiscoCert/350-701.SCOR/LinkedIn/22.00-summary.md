...
- Demo: enable malware scanning in WSA
  ...
  - Anti-Malware and Reputation > Anti-Malware and Reputation Settings
    ...
    - Ant-Malware Scanning Services: license key for Sophos, McAfee, or Webroot might required to enable
...
- Demo: config malware & reputation w/ policy group
