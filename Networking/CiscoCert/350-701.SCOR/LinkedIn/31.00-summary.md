...
- Demo: AMP policies
  ...
  - Edit Policy: Name = 'Server Policy' link: Mode and Engine, Exclusions, Proxy, Groups = Server (3); Outbreak Control - Custom Detectios - Simple, Custom Detection - Advanced, Application Control, Network > 'Edit' button
